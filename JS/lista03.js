...
/*
01 - Armazene um array vazio em uma let "brazilianFoods";
*/

let brazilianFoods = []

/*
02 - Use o método adequado para adicionar os 3 seguintes itens ao array:
- Coxinha
- null
- Brigadeiro
...
console.log('Ativade 02 - '+brazilianFoods)
...
console.log('Ativade 03 - '+brazilianFoods[1])
...
console.log('Ativade 04 - '+foodsInfo)
...
console.log('Ativade 05 - '+dogNames)
...
newDogNames = maleDogNames.join(', ') + ", " +femaleDogNames.join(', ')
console.log('Ativade 06 - '+newDogNames)
...
dogNames.pop()
console.log('Ativade 07 - '+dogNames[dogNames.length-1])
...
console.log('Ativade 08 - '+initials)
...
console.log('Ativade 09 - '+initials.toLowerCase())
...
let frase = `A ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`
console.log('Ativade 10 - '+frase)
...
oddNumbers[1] += 4
console.log('Ativade 11 - '+oddNumbers[1] * oddNumbers[1] * oddNumbers[1])