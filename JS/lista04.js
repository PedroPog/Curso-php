/* CJAM - CURSO DE JAVASCRIPT ANDRÉ MAURÍCIO 
 ...
 01 - Suba o seu servidor local e:
  ...
  - OBS:Forme essa frase sem digitar o nome das séries (claro) e sem utilizar a notação "array[index]";
  - Exiba a frase no console.
  "Minhas 3 séries favoritas são: SÉRIE_01, SÉRIE_02 e SÉRIE_03."
*/

const my3FavoriteTVShows = ["AOT", "Narnia", "The Office"];
const serie1 = my3FavoriteTVShows[0];
const serie2 = my3FavoriteTVShows[1];
const serie3 = my3FavoriteTVShows[2];
const final = `Minhas 3 séries favoritas são: ${serie1}, ${serie2} e ${serie3}`;

console.log("01-Exercício: " + final)
/*
...
const tamanho = my3FavoriteTVShows.length;
console.log("02-Exercício: ", tamanho == 3);


/*
  03 - Comente o console.log() acima e:
  - Após a constante abaixo, armazene em uma constante "isRandomTVShowIncluded"  
    um boolean que indica se a série que a const "randomTVShow" armazena é uma das suas 3 séries favoritas;
...
console.log("03-Exercício: " + isRandomTVShowIncluded);
...
const typeSentence = `04-Exercício: O tipo de dado que a const "isRandomTVShowIncluded" armazena é: ${typeof(isRandomTVShowIncluded)}`;
...
const mais = typeSentence.length > 39;
let resposta;
mais == true ? resposta = "True" : resposta = "False";

console.log("05-Exercício: " + `A string que a "typeSentence" armazena tem mais de  39
caracteres? ${resposta}`);
...
console.log("06-Exercício: " + `Todos os ${falsyValues.length} itens do array "falsyValues" são falsy. Inclusive o  
${falsyValues[2]}`)
/*
...
console.log("07-Exercício: ", crazyConversion);
...
console.log("08-Exercício: " + `  "A soma entre o 1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação  
é: ${agesSum <= 92}"`)
/*
...
const isNotAString = randomTVShow == String ? resposta = "True" : resposta = "False";
console.log("09-Exercício: " + isNotAString);
...
console.log("10-Exercício: " + evenNumbers.some(contem));
