...
/* 01 - abrir este arquivo no editor preferido de vocês:*/


/*
02 - Inicie o seu serviço do nodeJs no prompt de comando do windows para fazer os exercícios abaixo.
*/
...
console.log('Atividade 3º '+'Grandes poderes trazem grandes responsabilidades.');
...
const secordTom = 'Cruise';
const myFavoriteTom = (`${tom} ${secordTom}`);

console.log('Atividade 4º '+myFavoriteTom);
...
console.log('Atividade 7º '+programmingLanguage.length)
...
let randomWord = 'a'
console.log('Atividade 8º '+randomWord[randomWord.length-1])
...
console.log('Atividade 9º '+summerMessage.toLowerCase())
...
console.log('Atividade 10º '+winterMessage.toUpperCase())
...
console.log('Atividade 11º '+winterMessage.indexOf('v'))
...
console.log('Atividade 12º '+winterMessage.lastIndexOf('n'));
...
console.log('Atividade 13º '+harryPotterAuthor.slice(0,4))
...
console.log('Atividade 14º '+realBestMovie);
...
const reminder = 10 % 3;
console.log('Atividade 15º '+reminder);
...
let episodes = 6
episodes++
console.log('Atividade 16º '+episodes);
...
episodes--;
console.log('Atividade 17º '+episodes);
...
episodes = 10;
console.log('Atividade 18º '+episodes);
...
console.log('Atividade 19º '+allEpisodes)
...
*/
 ...
 console.log('Atividade 20º '+bookMessage)
...
const name1 = 'walter white'
let newName = (name1.slice(0,7).replace('w','W')+''+name1.slice(6,12).replace('w','W'));
console.log('Atividade 21º '+newName);
...
console.log('Atividade 22º '+`${name1.slice(0,7).replace('w','W')}${name1.slice(6,12).replace('w','W')}`)