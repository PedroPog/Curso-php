...
<body>
    ...
    <div class="container-fluid" style="margin-bottom: 10%;">
        <div class="row">
            <!-- linha -->
            <?php $consulta = $url->query("select idProduto,dsProduto,valor,dsCapa,estoque from listarprod where dsCategoria = '$cat'");
            while ($exibe = $consulta->fetch(PDO::FETCH_ASSOC)) { ?>
            <div class="col-sm-3 teste">
                <img src="assets/imagens/<?php echo $exibe['dsCapa'] ?>.png" alt="" class="img-responsive"
                    styles="width:100%">
                <div>
